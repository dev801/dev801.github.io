...
<button type="button" onclick="document.location='${contentsJSON.dlLink}'" style="background-color: #3ce000; margin: 5px; width: 100%;" class="btn" id="dwldBtn">DISCORD SERVER</button>
    `
}